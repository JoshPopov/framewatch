...
const stats = [
  {
    ...
    ghost: "90%",
    headline: "90%+",
    title: "Non-Consensual Material",
    copy: "Research indicates over 90% of deepfake content appearing on public forums is created without explicit permission.",
  },
  {
    icon: "\u2197",
    ghost: "10\u00D7",
    ...
    copy: "AI tooling has accelerated abuse creation and distribution, increasing malicious volume by over 1,000%.",
  },
  {
    icon: "\u25CE",
    ghost: "24/7",
    headline: "24/7",
    title: "Placeholder Coverage Metric",
    copy: "Placeholder: Continuous monitoring coverage placeholder text for additional trust indicator and future reporting data.",
  },
];
...
function MatrixGrid() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      const fadingIds = new Set<number>();
      setCells((prev) => {
        const next = [...prev];
        ...
        setCells((prev) =>
          prev.map((cell) => {
            ...
            return {
              ...
              color:
                MATRIX_COLORS[
                  Math.floor(Math.random() * MATRIX_COLORS.length)
                ],
      ...
      <div className="algo-container">
        <div className="algo-content" data-reveal>
          ...
          <p className="algo-text">
            Our proprietary multi-modal models analyze standard video feeds in
            real-time. By decomposing signals into distinct biometric layers, we
            can identify synthetic artifacts that are invisible to the naked eye.
          </p>
        </div>
        <div className="algo-visual" data-reveal>
          <div className="scan-grid">
            <div className="scan-line" />
            <div className="scan-node n1" />
            <div className="scan-node n2" />
            <div className="scan-node n3" />
          </div>
        </div>
      </div>
    </div>
...
function ExplodedRebuildSection() {
  useEffect(() => {
    ...
    const stage = document.querySelector(".mockup-stage") as HTMLElement;
    const heading = document.querySelector(".exploded-heading") as HTMLElement;

    const handleScroll = () => {
      if (!container || !stage || !heading) return;
      ...
      <div className="exploded-sticky">
        <div className="exploded-split-layout">
          <div className="mockup-stage">
            <article className="mock-piece piece-frame" />
          ...
          <div className="exploded-heading">
            ...
            <p className="lead">
              We separate every layer of media to verify authenticity. Audio
              waves, metadata headers, and frame-by-frame pixel density are
...
export default function LandingPage() {
  ...
  useEffect(() => {
    const links = document.querySelectorAll(".glass-nav .landing-nav a, .brand");
  ...
  return (
    <div className="landing-page">
      <header className="glass-nav">
        ...
        <Link href="/auth/login" className="btn-icon-profile" aria-label="Sign in">
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
        ...
        <section id="home" className="hero">
          ...
          <div className="hero-content hero-intro">
            <p className="hero-badge">
              <span className="pulse-dot" /> AUTOMATED IDENTITY DEFENSE v2.0
            </p>
            <h1>
              Your Face.
              <br />
            ...
            <p className="lead">
              If someone is using your face or voice without consent. We&apos;ll
              know about it, and we&apos;ll take it down. Instantly.
            </p>
          </div>
        </section>
